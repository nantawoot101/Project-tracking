            ...
            '<div class="uk-htmleditor-navbar">',
                ...
                '<div class="uk-htmleditor-navbar-flip">',
                    '<ul class="uk-htmleditor-navbar-nav">',
                        ...
                        '<li><a data-htmleditor-button="fullscreen"><i icon-to-svg class="uk-icon-expand"></i></a></li>',
                    '</ul>',
                '</div>',
            '</div>',
    ...
    UI.plugin('htmleditor', 'base', {
        ...
        init: function(editor) {
            ...
            editor.addButtons({
                ...
                fullscreen: {
                    title  : 'Fullscreen',
                    label  : '<i icon-to-svg class="uk-icon-expand"></i>'
                },
                bold : {
                    title  : 'Bold',
                    label  : '<i icon-to-svg class="uk-icon-bold"></i>'
                },
                italic : {
                    title  : 'Italic',
                    label  : '<i icon-to-svg class="uk-icon-italic"></i>'
                },
                strike : {
                    title  : 'Strikethrough',
                    label  : '<i icon-to-svg class="uk-icon-strikethrough"></i>'
                },
                blockquote : {
                    title  : 'Blockquote',
                    label  : '<i icon-to-svg class="uk-icon-quote-right"></i>'
                },
                link : {
                    title  : 'Link',
                    label  : '<i icon-to-svg class="uk-icon-link"></i>'
                },
                image : {
                    title  : 'Image',
                    label  : '<i icon-to-svg class="uk-icon-picture-o"></i>'
                },
                listUl : {
                    title  : 'Unordered List',
                    label  : '<i icon-to-svg class="uk-icon-list-ul"></i>'
                },
                listOl : {
                    title  : 'Ordered List',
                    label  : '<i icon-to-svg class="uk-icon-list-ol"></i>'
                }
